...
<body>
  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <br>
      Телефон (вводить в формате +7 (123) 567-43-32):<br><input type="tel" name="phone" <?php if ($errors['phone']) {print 'class="group error"';} else print 'class="group"'; ?> value="<?php print $values['phone']; ?>">
      <br>
      E-mail:
