...
<body>
    ...
    <div class="fon1 tab mt-4 mb-4 shadow rounded">
        <img src="img/start.png" alt="Image 1">
        <br>
        <img src="img/sql.png" alt="Image 2">
        <br>
        <img src="img/form.png" alt="Image 3">
        <br>
        <img src="img/form1.png" alt="Image 4">
        <br>
        <img src="img/form2.png" alt="Image 5">
        <br>
        <img src="img/form3.png" alt="Image 6">
        <br>
    </div>
</body>
